    ...
    (
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ fontSize: 44, fontWeight: 800, color: '#111', marginBottom: 8 }}>SEO Glossary</div>
          <div style={{ fontSize: 24, color: '#444' }}>Definitions for 100+ essential SEO terms</div>
        </div>
