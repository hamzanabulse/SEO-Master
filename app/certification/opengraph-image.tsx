    ...
    (
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ fontSize: 44, fontWeight: 800, color: '#111', marginBottom: 8 }}>SEO Certification</div>
          <div style={{ fontSize: 24, color: '#444' }}>Earn and download your certificate</div>
        </div>
