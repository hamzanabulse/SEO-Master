    ...
    (
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ fontSize: 44, fontWeight: 800, color: '#111', marginBottom: 8 }}>SEO Fundamentals</div>
          <div style={{ fontSize: 24, color: '#444' }}>Core concepts, E-E-A-T, and best practices</div>
        </div>
